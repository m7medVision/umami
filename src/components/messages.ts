export const labels: Record<string, string> = {
  ...
  twoFactorScanQr: 'label.two-factor-scan-qr',
  twoFactorCantScan: 'label.two-factor-cant-scan',
  twoFactorManualEntry: 'label.two-factor-manual-entry',
  twoFactorCopyCode: 'label.two-factor-copy-code',
  twoFactorCodeCopied: 'label.two-factor-code-copied',
  twoFactorGetCode: 'label.two-factor-get-code',
  twoFactorEnterCode: 'label.two-factor-enter-code',
  twoFactorUseBackup: 'label.two-factor-use-backup',
  twoFactorSaveBackupCodes: 'label.two-factor-save-backup-codes',
  twoFactorDownloadCodes: 'label.two-factor-download-codes',
  twoFactorSavedCodes: 'label.two-factor-saved-codes',
  twoFactorBackupFileTitle: 'label.two-factor-backup-file-title',
  twoFactorSuccessTitle: 'label.two-factor-success-title',
  twoFactorEnable: 'label.two-factor-enable',
  twoFactorDisable: 'label.two-factor-disable',
  twoFactorDisableTitle: 'label.two-factor-disable-title',
  twoFactorStatusNotConfigured: 'label.two-factor-status-not-configured',
  twoFactorActive: 'label.two-factor-active',
  twoFactorRequireGlobal: 'label.two-factor-require-global',
  twoFactorRequireUser: 'label.two-factor-require-user',
  twoFactorRequireTeam: 'label.two-factor-require-team',
  twoFactorReset: 'label.two-factor-reset',
  ...
  status: 'label.status',
  experimentStatus: 'label.experiment-status',
  notifications: 'label.notifications',
  unread: 'label.unread',
  viewRun: 'label.view-run',
  markRead: 'label.mark-read',
  createExperiment: 'label.create-experiment',
  featureFlag: 'label.feature-flag',
  noRuns: 'label.no-runs',
  latestRun: 'label.latest-run',
  run: 'label.run',
  runs: 'label.runs',
  experimentDefinition: 'label.experiment-definition',
  variationsAndBaseline: 'label.variations-and-baseline',
  variations: 'label.variations',
  baseline: 'label.baseline',
  trafficWeight: 'label.traffic-weight',
  fallthrough: 'label.fallthrough',
  rolloutPercentage: 'label.rollout-percentage',
  audienceAndInterference: 'label.audience-and-interference',
  audienceSegment: 'label.audience-segment',
  exclusionSegment: 'label.exclusion-segment',
  mutualExclusionGroup: 'label.mutual-exclusion-group',
  outcomes: 'label.outcomes',
  addOutcome: 'label.add-outcome',
  primaryOutcome: 'label.primary-outcome',
  secondaryOutcome: 'label.secondary-outcome',
  secondaryOutcomes: 'label.secondary-outcomes',
  makePrimary: 'label.make-primary',
  outcomeType: 'label.outcome-type',
  outcomeSource: 'label.outcome-source',
  standardMetric: 'label.standard-metric',
  numericField: 'label.numeric-field',
  countingMode: 'label.counting-mode',
  attributionScope: 'label.attribution-scope',
  visitorWindowDays: 'label.visitor-window-days',
  desiredDirection: 'label.desired-direction',
  removeOutcome: 'label.remove-outcome',
  safeguards: 'label.safeguards',
  minimumSamplePerVariation: 'label.minimum-sample-per-variation',
  minimumActiveDays: 'label.minimum-active-days',
  probabilityToWinThreshold: 'label.probability-to-win-threshold',
  expectedLossThreshold: 'label.expected-loss-threshold',
  sampleRatioMismatchAlpha: 'label.sample-ratio-mismatch-alpha',
  sampleRuntimeGuidance: 'label.sample-runtime-guidance',
  baselineRatePercent: 'label.baseline-rate-percent',
  minimumDetectableEffectPercent: 'label.minimum-detectable-effect-percent',
  expectedDailyTraffic: 'label.expected-daily-traffic',
  unitsPerVariation: 'label.units-per-variation',
  estimatedDays: 'label.estimated-days',
  reviewFrozenSnapshot: 'label.review-frozen-snapshot',
  review: 'label.review',
  startAfterCreate: 'label.start-after-create',
  createAndStart: 'label.create-and-start',
  createDraft: 'label.create-draft',
  start: 'label.start',
  openRunDashboard: 'label.open-run-dashboard',
  backToExperiments: 'label.back-to-experiments',
};
...
export const messages: Record<string, string> = {
  ...
  twoFactorSetupDescription: 'message.two-factor-setup-description',
  twoFactorSetupRequiredDescription: 'message.two-factor-setup-required-description',
  twoFactorStep1Description: 'message.two-factor-step1-description',
  twoFactorStep2Description: 'message.two-factor-step2-description',
  twoFactorEnabledDescription: 'message.two-factor-enabled-description',
  ...
  twoFactorDisableDescription: 'message.two-factor-disable-description',
  twoFactorRequiredMessage: 'message.two-factor-required-message',
  twoFactorOverrideNote: 'message.two-factor-override-note',
  twoFactorAdminGlobalDescription: 'message.two-factor-admin-global-description',
  twoFactorRequireUserDescription: 'message.two-factor-require-user-description',
  twoFactorRequireTeamDescription: 'message.two-factor-require-team-description',
  twoFactorUserDescription: 'message.two-factor-user-description',
  twoFactorLockedMessage: 'message.two-factor-locked-message',
  twoFactorActiveDescription: 'message.two-factor-active-description',
  twoFactorResetDescription: 'message.two-factor-reset-description',
  twoFactorErrorInvalidCode: 'message.two-factor-error-invalid-code',
  twoFactorErrorMissingToken: 'message.two-factor-error-missing-token',
  twoFactorErrorInvalidPartialToken: 'message.two-factor-error-invalid-partial-token',
  twoFactorErrorInvalidBackupCode: 'message.two-factor-error-invalid-backup-code',
  twoFactorErrorCodeUsed: 'message.two-factor-error-code-used',
  ...
  noExperiments: 'message.no-experiments',
  loadingExperimentNotifications: 'message.loading-experiment-notifications',
  noExperimentNotifications: 'message.no-experiment-notifications',
  experimentNotificationViewer: 'message.experiment-notification-viewer',
  experimentCreated: 'message.experiment-created',
  loadingExperimentSetup: 'message.loading-experiment-setup',
  experimentEditorRequired: 'message.experiment-editor-required',
  experimentFlagRequired: 'message.experiment-flag-required',
  experimentVariationLimit: 'message.experiment-variation-limit',
  experimentVariationFrozen: 'message.experiment-variation-frozen',
  experimentBaselineFallthrough: 'message.experiment-baseline-fallthrough',
  experimentInterferenceWarning: 'message.experiment-interference-warning',
  experimentSegmentsFrozen: 'message.experiment-segments-frozen',
  experimentOutcomeLimit: 'message.experiment-outcome-limit',
  experimentGuidanceOnly: 'message.experiment-guidance-only',
  experimentNoExclusionGroup: 'message.experiment-no-exclusion-group',
  experimentFutureOnlyWarning: 'message.experiment-future-only-warning',
  experimentAwaitFlagsWarning: 'message.experiment-await-flags-warning',
  experimentSecurityWarning: 'message.experiment-security-warning',
  loadingExperiment: 'message.loading-experiment',
  noExperimentRuns: 'message.no-experiment-runs',
};
